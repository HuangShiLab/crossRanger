...
* `n_cores = 1` runs sequentially without starting a cluster at all, and the functions run
  sequentially while the package is checked: on Windows, starting a cluster took far longer than
  the analyses of the examples themselves.
